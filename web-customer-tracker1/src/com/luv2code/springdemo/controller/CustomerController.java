...
public class CustomerController {
	...
	@GetMapping("/delete")
	public String delete(@ModelAttribute("customerId") int theId,Model theModel)
	{
	...
	@GetMapping("/search")
	public String search(@ModelAttribute("theSearchName") String theSearchName, Model theModel)
	{
